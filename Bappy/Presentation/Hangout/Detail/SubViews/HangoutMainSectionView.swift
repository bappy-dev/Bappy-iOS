...
final class HangoutMainSectionView: UIView {
    ...
    private func layout() {
        let vStackView = UIStackView(arrangedSubviews: [
            timeImageView, languageImageView, placeImageView, urlImageView
        ])
        ...
        let goOpenchatImageView = UIImageView()
        goOpenchatImageView.image = UIImage(named: "detail_arrow")
        goOpenchatImageView.contentMode = .center
        ...
        openchatButton.snp.makeConstraints {
            $0.centerY.equalTo(urlImageView)
            $0.leading.equalTo(placeTextField)
        }
        
        openchatButton.addSubview(goOpenchatImageView)
        goOpenchatImageView.snp.makeConstraints {
