...
final class ProfileEditPersonalityViewModel: ViewModelType {
    ...
    struct Input {
        var spontaneousButtonTapped: AnyObserver<Void>
        var planningButtonTapped: AnyObserver<Void>
        var talkativeButtonTapped: AnyObserver<Void>
        var empathicButtonTapped: AnyObserver<Void>
        var shyButtonTapped: AnyObserver<Void>
        var calmButtonTapped: AnyObserver<Void>
        var politeButtonTapped: AnyObserver<Void>
    }
